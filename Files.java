...
public class Files{
    ...
    public static void Files(){
    	...
    	File[] fileSources = new File();
    	File outputFile= new File();
    	int transCode;
    	
    	String inputFileName = new String (); //string of the file to that needs to be checked for negative value
        
    	
    	public mergeTransFiles(File outputFile, File[] fileSources) throws IOException{
            //TODO: Merge transaction files
        }
